...
import { coerceDatePickerValue } from "@/utils";

const userStore = useUserStore();
const { goBack } = useAppActions();
const updateForm = ref<any>(null);
/** 用户资料写入 birth 后递增，强制日期选择器重挂载，避免异步覆盖 modelValue 时内部面板状态错乱 */
const birthPickerKey = ref(0);
