...
public class SingerServiceImpl extends ServiceImpl<SingerMapper, Singer> implements SingerService {
    ...
    @Override
    public R allSinger() {
        List<Singer> list = singerMapper.selectList(null);
        songSingerPicSupport.resolvePicsForResponse(list);
    ...
    public R pageSinger(Integer page, Integer size) {
        ...
        songSingerPicSupport.resolvePicsForResponse(pageInfo.getRecords());
        Map<String, Object> data = new HashMap<>();
    ...
    public R singerOfName(String name) {
        ...
        List<Singer> list = singerMapper.selectList(queryWrapper);
        songSingerPicSupport.resolvePicsForResponse(list);
        return R.success(null, list);
    }
