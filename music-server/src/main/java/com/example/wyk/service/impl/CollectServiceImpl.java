...
import com.example.wyk.mapper.CollectMapper;
...
import com.example.wyk.model.domain.Collect;
import com.example.wyk.model.domain.Song;
import com.example.wyk.model.domain.SongList;
import com.example.wyk.model.request.CollectRequest;
import com.example.wyk.service.CollectService;
    ...
    public R addCollection(CollectRequest addCollectRequest) {
        ...
        if (collectMapper.insert(collect) > 0) {
            if (collect.getSongId() != null && collect.getType() != null && collect.getType() == 0) {
                stringRedisTemplate.delete("song:rank:collect");
            }
            if (collect.getSongListId() != null && collect.getType() != null && collect.getType() == 1) {
                stringRedisTemplate.delete("songList:rank:collect");
            }
